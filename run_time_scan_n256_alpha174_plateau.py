            ...
            cases.append(
                {
                    ...
                    "outdir": Path("results") / "time_scan_N256_alpha174_plateau",
                    "cfg": make_cfg(
                        N=N_FIXED,
                        alpha=alpha,
                        T=T,
...
manifest_path = Path("results") / "time_scan_N256_alpha174_plateau_manifest.csv"
...
table_path = Path("results") / "time_scan_N256_alpha174_plateau_table.csv"
...
summary_path = Path("results") / "time_scan_N256_alpha174_plateau_alpha_time_summary.csv"
