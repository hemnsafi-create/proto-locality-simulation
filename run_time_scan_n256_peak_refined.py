...
ALPHA_LIST = [1.80]
T_LIST = [370.0, 380.0, 390.0, 410.0, 420.0, 430.0]
SEEDS = [101, 102, 103]
N_FIXED = 256
            ...
            cases.append(
                {
                    ...
                    "outdir": Path("results") / "time_scan_N256_peak_refined",
                    "cfg": make_cfg(
                        N=N_FIXED,
                        alpha=alpha,
                        T=T,
...
manifest_path = Path("results") / "time_scan_N256_peak_refined_manifest.csv"
...
table_path = Path("results") / "time_scan_N256_peak_refined_table.csv"
...
summary_path = Path("results") / "time_scan_N256_peak_refined_alpha_time_summary.csv"
