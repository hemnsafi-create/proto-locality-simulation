            ...
            cases.append(
                {
                    ...
                    "outdir": Path("results") / "time_scan_N256_alpha180_seedexp",
                    "cfg": make_cfg(
                        N=N_FIXED,
                        alpha=alpha,
                        T=T,
...
manifest_path = Path("results") / "time_scan_N256_alpha180_seedexp_manifest.csv"
...
table_path = Path("results") / "time_scan_N256_alpha180_seedexp_table.csv"
...
summary_path = Path("results") / "time_scan_N256_alpha180_seedexp_alpha_time_summary.csv"
