...
T_LIST = [320.0, 330.0, 340.0, 350.0, 360.0]
SEEDS = [101, 102, 103]
N_FIXED = 192
            ...
            cases.append(
                {
                    ...
                    "outdir": Path("results") / "time_scan_N192_refined",
                    "cfg": make_cfg(
                        N=N_FIXED,
                        alpha=alpha,
                        T=T,
...
manifest_path = Path("results") / "time_scan_N192_refined_manifest.csv"
...
table_path = Path("results") / "time_scan_N192_refined_table.csv"
...
summary_path = Path("results") / "time_scan_N192_refined_alpha_time_summary.csv"
