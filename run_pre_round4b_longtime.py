...
for i, case in enumerate(CASES, start=1):
    ...
    label = f"N{cfg_dict['N']}_a1.8_T1000_seed{cfg_dict['seed']}"
    outdir = Path("results") / "pre_round4b_longtime"
...
manifest_path = Path("results") / "pre_round4b_longtime_manifest.csv"
