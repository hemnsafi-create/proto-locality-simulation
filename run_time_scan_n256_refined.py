...
ALPHA_LIST = [1.80]
T_LIST = [320.0, 360.0, 400.0, 440.0, 480.0, 560.0]
SEEDS = [101, 102, 103]
N_FIXED = 256
            ...
            cases.append(
                {
                    ...
                    "outdir": Path("results") / "time_scan_N256_refined",
                    "cfg": make_cfg(
                        N=N_FIXED,
                        alpha=alpha,
                        T=T,
...
manifest_path = Path("results") / "time_scan_N256_refined_manifest.csv"
...
table_path = Path("results") / "time_scan_N256_refined_table.csv"
...
summary_path = Path("results") / "time_scan_N256_refined_alpha_time_summary.csv"
